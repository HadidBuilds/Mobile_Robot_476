...
Romi32U4ButtonA buttonA;
   ...
   // Parameters
   const int motor_power = 90;      // -300 to 300
...
void goStraight()
{
    ...
    while ( (enc_l < target_count) && (enc_r < target_count) ) {
      enc_r = abs(encoders.getCountsRight());
...
void turn90()
{
    // (90/360)*(robot_width*pi)/10 ~=11.07 cm bumped up to 12 cm for different surface
    int drive_distance = 11.07;   // cm
